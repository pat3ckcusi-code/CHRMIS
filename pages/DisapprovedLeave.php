            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="disapprovedleave_table" class="table table-striped table-bordered table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Type of Leave</th>
...
<script>	  
    ...
    var usersTable = $('#disapprovedleave_table').DataTable({
        responsive: true,
        order: [[0, "asc"]],
        ajax: {
            url: '../api/api_leave.php?disapprovedleave_table',
            data: function (d) {
