...
if (!isset($_SESSION["EmpID"])) {
    die("Error: No employee ID in session. Please log in again.");
}
//include("dbcon.php");
...
<head>
    ...
    <title>CALAPAN CITY PRIME CHRMD</title>
   ...
   <?php
        // First check if $row exists and is an array
        if (is_array($row) && isset($row['Password'])) {
            if ($row['Password'] == 'password') {
                //echo "<script type='text/javascript'>alert('Please Change your Password. Thank You!');</script>";
                ?>
            ...
            error_log("No user data found or invalid row format");
        }
        ?>
</head>
<body>
    ...
    <table class="table table-bordered table-hover">
      <tbody>
        ...
        <tr>
          ...
          <td>
            <input class="form-control form-control-sm" name="txtPlace" id="txtPlace"
                    value="<?php echo isset($row['BirthPlace']) ? htmlspecialchars($row['BirthPlace']) : ''; ?>">
          </td>
        </tr>
        ...
        <tr>
          ...
          <td><input class="form-control form-control-sm" name="txtPhilhealth"  value="<?php echo isset($row['Philhealth']) ? htmlspecialchars($row['Philhealth']) : ''; ?>" />
        </tr>
        <tr>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtElem" type="text" id="txtElem" value="<?php echo (is_array($row1) && isset($row1['SchoolName'])) ? htmlspecialchars($row1['SchoolName']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtElemEduc" type="text" id="txtElemEduc" value="<?php echo (is_array($row1) && isset($row1['Course'])) ? htmlspecialchars($row1['Course']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtElemFrom" type="text" id="txtFrom1" value="<?php echo (is_array($row1) && isset($row1['PeriodFrom'])) ? htmlspecialchars($row1['PeriodFrom']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtElemTo" type="text" id="txtTo1" value="<?php echo (is_array($row1) && isset($row1['PeriodTo'])) ? htmlspecialchars($row1['PeriodTo']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtElemUnits" type="text" id="txtUnits1" value="<?php echo (is_array($row1) && isset($row1['Units'])) ? htmlspecialchars($row1['Units']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtElemYearGrad" type="text" id="txtYearGrad1" value="<?php echo (is_array($row1) && isset($row1['YearGrad'])) ? htmlspecialchars($row1['YearGrad']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtElemHonor" type="text" id="txtHonor1" value="<?php echo (is_array($row1) && isset($row1['Honors'])) ? htmlspecialchars($row1['Honors']) : ''; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style2" style="text-align: center;">
                                    ...
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtSecondary" type="text" id="txtSecondary" value="<?php echo (is_array($row1) && isset($row1['SchoolName'])) ? htmlspecialchars($row1['SchoolName']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtSecondEduc" type="text" id="txtSecondEduc" value="<?php echo (is_array($row1) && isset($row1['Course'])) ? htmlspecialchars($row1['Course']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtSecondFrom" type="text" id="txtFrom2" value="<?php echo (is_array($row1) && isset($row1['PeriodFrom'])) ? htmlspecialchars($row1['PeriodFrom']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtSecondTo" type="text" id="txtTo2" value="<?php echo (is_array($row1) && isset($row1['PeriodTo'])) ? htmlspecialchars($row1['PeriodTo']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtSecondUnits" type="text" id="txtUnits2" value="<?php echo (is_array($row1) && isset($row1['Units'])) ? htmlspecialchars($row1['Units']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtSecondYearGrad" type="text" id="txtYearGrad2" value="<?php echo (is_array($row1) && isset($row1['YearGrad'])) ? htmlspecialchars($row1['YearGrad']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtSecondHonor" type="text" id="txtHonor2" value="<?php echo (is_array($row1) && isset($row1['Honors'])) ? htmlspecialchars($row1['Honors']) : ''; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style2" style="text-align: center;">
                                    ...
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtVocational" type="text" id="txtVocational" value="<?php echo (is_array($row1) && isset($row1['SchoolName'])) ? htmlspecialchars($row1['SchoolName']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtVocDeg" type="text" id="txtVocDeg" value="<?php echo (is_array($row1) && isset($row1['Course'])) ? htmlspecialchars($row1['Course']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtVocFrom" type="text" id="txtFrom3" value="<?php echo (is_array($row1) && isset($row1['PeriodFrom'])) ? htmlspecialchars($row1['PeriodFrom']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtVocTo" type="text" id="txtTo3" value="<?php echo (is_array($row1) && isset($row1['PeriodTo'])) ? htmlspecialchars($row1['PeriodTo']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtVocUnits" type="text" id="txtUnits3" value="<?php echo (is_array($row1) && isset($row1['Units'])) ? htmlspecialchars($row1['Units']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtVocYearGrad" type="text" id="txtYearGrad3" value="<?php echo (is_array($row1) && isset($row1['YearGrad'])) ? htmlspecialchars($row1['YearGrad']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtVocHonor" type="text" id="txtHonor3" value="<?php echo (is_array($row1) && isset($row1['Honors'])) ? htmlspecialchars($row1['Honors']) : ''; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style2" style="text-align: center;">
                                    ...
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtCollege" type="text" id="txtCollege" value="<?php echo (is_array($row1) && isset($row1['SchoolName'])) ? htmlspecialchars($row1['SchoolName']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtCollegeDeg" type="text" id="txtCollegeDeg" value="<?php echo (is_array($row1) && isset($row1['Course'])) ? htmlspecialchars($row1['Course']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtCollegeFrom" type="text" id="txtFrom4" value="<?php echo (is_array($row1) && isset($row1['PeriodFrom'])) ? htmlspecialchars($row1['PeriodFrom']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtCollegeTo" type="text" id="txtTo4" value="<?php echo (is_array($row1) && isset($row1['PeriodTo'])) ? htmlspecialchars($row1['PeriodTo']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtCollegeUnits" type="text" id="txtUnits4" value="<?php echo (is_array($row1) && isset($row1['Units'])) ? htmlspecialchars($row1['Units']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtCollegeYearGrad" type="text" id="txtYearGrad4" value="<?php echo (is_array($row1) && isset($row1['YearGrad'])) ? htmlspecialchars($row1['YearGrad']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtCollegeHonor" type="text" id="txtHonor4" value="<?php echo (is_array($row1) && isset($row1['Honors'])) ? htmlspecialchars($row1['Honors']) : ''; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style2" style="text-align: center;">
                                    ...
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtGradStudies" type="text" id="txtGradStudies" value="<?php echo (is_array($row1) && isset($row1['SchoolName'])) ? htmlspecialchars($row1['SchoolName']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtGradDeg" type="text" id="txtGradDeg" value="<?php echo (is_array($row1) && isset($row1['Course'])) ? htmlspecialchars($row1['Course']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtGradFrom" type="text" id="txtFrom5" value="<?php echo (is_array($row1) && isset($row1['PeriodFrom'])) ? htmlspecialchars($row1['PeriodFrom']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtGradTo" type="text" id="txtTo5" value="<?php echo (is_array($row1) && isset($row1['PeriodTo'])) ? htmlspecialchars($row1['PeriodTo']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtGradUnits" type="text" id="txtUnits5" value="<?php echo (is_array($row1) && isset($row1['Units'])) ? htmlspecialchars($row1['Units']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtGradYearGrad" type="text" id="txtYearGrad5" value="<?php echo (is_array($row1) && isset($row1['YearGrad'])) ? htmlspecialchars($row1['YearGrad']) : ''; ?>" />
                                    </td>
                                    <td style="text-align: center">
                                        <input class="form-control" name="txtGradHonor" type="text" id="txtHonor5" value="<?php echo (is_array($row1) && isset($row1['Honors'])) ? htmlspecialchars($row1['Honors']) : ''; ?>" />
                                    </td>
                                </tr>
                            </table>
                        </div>
