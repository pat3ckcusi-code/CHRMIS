...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Leave For Recommendation</h1>
        </div>
      </div>
    </div>
  </section>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="ForRecom" class="table table-striped table-bordered table-hover w-100">                            
                        </table>
                    </div>
                </div>
            </div>
...
<script>	  
    ...
    var usersTable = $('#ForRecom').DataTable({
        responsive: true,
        order: [[0, "asc"]],
        ajax: {
            //url: '../api/api_leave.php?ForRecom',
            url: '../api/api_leave.php?ForRecom',
            data: function (d) {
