...
<div class="row">
    <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
        <div class="small-box bg-info clickable-card" data-file="../partials/on_duty.php">
            <div class="inner">
                <h3><?php echo $kpis['utilization_pct']; ?><sup style="font-size:16px">%</sup></h3>
                <p>Utilization</p>
            </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
        <div class="small-box bg-warning clickable-card" data-file="../partials/lwop.php">
            <div class="inner">
                <h3><?php echo $kpis['lwop_pct']; ?><sup style="font-size:16px">%</sup> <small style="font-size:12px">(<?php echo $kpis['lwop_count']; ?>)</small></h3>
                <p>LWOP</p>
            </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
        <div class="small-box bg-danger clickable-card" data-file="../partials/risk_index.php">
            <div class="inner">
                <?php $ri = intval($kpis['risk_index']); ?>
                <h3><?php echo $ri; ?><small style="font-size:12px">/100</small></h3>
                <p>Risk Index</p>
            </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
        <div class="small-box bg-success clickable-card" data-file="../partials/approval_time.php">
            <div class="inner">
                <h3><?php echo $kpis['approval_time_days']; ?><small style="font-size:12px">d</small></h3>
                <p>Approval Time</p>
            </div>
...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header" style="color: #FFFFFF; background-color: #006666; font-weight: 600;"><h3 class="card-title">Leave Trend (Monthly)</h3></div>
            <div class="card-body"><canvas id="trendChart" height="140"></canvas></div>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header" style="color: #FFFFFF; background-color: #006666; font-weight: 600;"><h3 class="card-title">Leave Distribution (Type)</h3></div>
...
<div class="card">
    <div class="card-header" style="color: #FFFFFF; background-color: #006666; font-weight: 600;"><h3 class="card-title">Department Stability</h3></div>
    <div class="card-body">
        <div class="row">
            <div class="col-lg-8">
                <div class="table-responsive">
...
<!-- HR DECISION PANEL -->
<div class="card">
    <div class="card-header" style="color: #FFFFFF; background-color: #006666; font-weight: 600;"><h3 class="card-title">HR Decision Panel</h3></div>
